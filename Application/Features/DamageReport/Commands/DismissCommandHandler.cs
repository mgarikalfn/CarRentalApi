...
public class DismissCommandHandler
    : IRequestHandler<DismissCommand, Result<DamageReportDto>>
{
    private readonly IDamageReportRepository _repository;
    private readonly IMapper _mapper;

    public DismissCommandHandler(IDamageReportRepository repository, IMapper mapper)
    {
