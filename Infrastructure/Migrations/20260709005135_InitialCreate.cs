        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DriverLicenseVerifiedDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReporterId1 = table.Column<string>(type: "text", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DamageReports_Users_ReporterId1",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<int>(type: "integer", nullable: false),
                    PayerId1 = table.Column<string>(type: "text", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Payments_Users_PayerId1",
                        column: x => x.PayerId1,
                        principalTable: "Users",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VehicleReviewBookingId = table.Column<int>(type: "integer", nullable: true),
                    RenterReviewBookingId = table.Column<int>(type: "integer", nullable: true),
                    VehicleId = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Reviews_Bookings_RenterReviewBookingId",
                        column: x => x.RenterReviewBookingId,
                        principalTable: "Bookings",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Reviews_Bookings_VehicleReviewBookingId",
                        column: x => x.VehicleReviewBookingId,
                        principalTable: "Bookings",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DamageReports_ReporterId1",
                table: "DamageReports",
                column: "ReporterId1");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Payments_PayerId1",
                table: "Payments",
                column: "PayerId1");

            migrationBuilder.CreateIndex(
                name: "IX_Reviews_RenterReviewBookingId",
                table: "Reviews",
                column: "RenterReviewBookingId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reviews_VehicleReviewBookingId",
                table: "Reviews",
                column: "VehicleReviewBookingId",
                unique: true);
